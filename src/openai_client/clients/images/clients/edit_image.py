...
class URL_Image_Edit_Client(OpenAI_Image_Client, Image_Context_Manager_Mixin):
    ...
    def __init__(self, image:Union[str, BufferedReader], mask:Union[str, BufferedReader], api_key: str = None, max_retries=3, ms_between_retries=500, default_size:IMAGE_SIZE = None, 
